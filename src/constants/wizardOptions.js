export const SAUCES_ARRAY = [
  { id: 'tomato', label: 'Томатный', value: 'tomato' },
  { id: 'white', label: 'Белый', value: 'white' },
  { id: 'spicy', label: 'Острый', value: 'spicy' },
];
...
export const SIZES_ARRAY = [
  { id: '30', label: '30 см', value: '30' },
  { id: '35', label: '35 см', value: '35' },
];
